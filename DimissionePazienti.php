...
require "protected/connessione.php";
    if(count($_SESSION) && ($_SESSION['utente_Medbase']->privilegio & 4) > 0){
        echo "  <div class='row'>
                    ...
                    <div class='col-lg-4 col-10' style='text-align: center'>
                        <div class='box example' style='width: 100%'>
                            ...
                            <input type='text'  required placeholder='Codice fiscale' name='search' id='SearchText'>
        ...
        echo "<div class='row'>
                <div class='col-lg-4 col-1'></div>
                <div class='col-lg-4 col-10 box' id='SchedaPaziente'>
